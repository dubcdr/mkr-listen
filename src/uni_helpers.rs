        ...
        T: JsonRpcClient,
    {
        ...
        match txn_inputs {
            ...
            UniTxnInput::SwapToken(inputs) => match method {
                UniTxnMethod::Token(TokenTxnMethod::ExactTokensForTokens)
                | UniTxnMethod::Token(TokenTxnMethod::ExactTokensForEth) => {
                    let destination_address: Option<Address> = match method {
                        UniTxnMethod::Token(TokenTxnMethod::ExactTokensForEth) => None,
                        UniTxnMethod::Token(TokenTxnMethod::ExactTokensForTokens) => {
...
fn decode_txn_method(txn: &Transaction) -> Option<UniTxnMethod> {
    ...
    match method_str {
        "0x7ff36ab5" => Some(UniTxnMethod::Eth(EthTxnMethod::ExactEthForTokens)),
        "0xfb3bdb41" => Some(UniTxnMethod::Eth(EthTxnMethod::EthForExactTokens)),
        "0x18cbafe5" => Some(UniTxnMethod::Token(TokenTxnMethod::ExactTokensForEth)),
        "0x38ed1739" => Some(UniTxnMethod::Token(TokenTxnMethod::ExactTokensForTokens)),
    ...
    T: JsonRpcClient,
{
    ...
    let txn_inputs = match txn_method {
        UniTxnMethod::Eth(EthTxnMethod::ExactEthForTokens) => UniTxnInput::SwapEth(
            uniswap_router_contract
                .decode("swapExactETHForTokens", &txn.input)
                .unwrap(),
        ),
        UniTxnMethod::Eth(EthTxnMethod::EthForExactTokens) => UniTxnInput::SwapEth(
            uniswap_router_contract
                .decode("swapETHForExactTokens", &txn.input)
                .unwrap(),
        ),
        UniTxnMethod::Token(TokenTxnMethod::ExactTokensForEth) => UniTxnInput::SwapToken(
            uniswap_router_contract
                .decode("swapExactTokensForETH", &txn.input)
                .unwrap(),
        ),
        UniTxnMethod::Token(TokenTxnMethod::ExactTokensForTokens) => UniTxnInput::SwapToken(
            uniswap_router_contract
